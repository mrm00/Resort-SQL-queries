...
SELECT DISTINCT concat(members.firstname,' ',members.surname) AS user, bookings.facid, facilities.name
...
SELECT facilities.name, concat(members.firstname, ' ', members.surname) AS user, bookings.starttime,
